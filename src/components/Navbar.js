  ...
  return (
    <Nav theme={theme}>
      ...
      <DropdownMenu
        ...
        <li><a href="https://script.google.com/macros/s/AKfycbyNXloPFC_uqhAFbFkTDSDiwWE3zQeTYfAEULkfOj216o-NhCI64NMpOM8QJo1YIJyg/exec" target="_blank" rel="noopener noreferrer" theme={theme} onClick={toggleMenu}>JOIN US</a></li>
      </DropdownMenu>
    </Nav>
  );
};
